    ...
    render() { return (
            ...
            <form onSubmit={(e) => {
                ...
                <div className="form-group row">
                    ...
                    <div className="col-md-3">
                        <input type="text" id="display_name" className="form-control" ref={(node) => this.display_name = node } placeholder="optional" />
                    </div>
                </div>
                <div className="form-group row">
                    ...
                    <div className="col-md-3">
                        <input type="text" id="phone" className="form-control" placeholder="XXX-XXX-XXXX" 
                ...
                <div className="form-group row">
                  ...
                  <div className="col-md-3">
                        <input type="text" id="birth" className="form-control" placeholder="XX-XX-XXXX" 
                        pattern="\d\d-\d\d-\d\d\d\d" ref={(node) => this.birth = node }
                        title="birth should be the format of 05-08-1993" required/>
                  </div>
